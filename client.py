...
def MusicWindow():
    ...
    connectserver = Button(window,text="Connect to Chat Server",bd=1, font = ("Calibri",10), command=connectServer)
    ...
    Stop=Button(window, text="stop",bd=1,width=10, bg='SkyBlue', font=("Calibri",103) )
